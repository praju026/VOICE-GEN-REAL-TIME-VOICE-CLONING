...
from toolbox.login import LoginWindow  # Add this
from PyQt5.QtWidgets import QApplication, QDialog
from toolbox.login import LoginWindow
...
class Toolbox:
    def __init__(self, datasets_root: Path, models_dir: Path, seed: int=None):
        ...
        if login_window.exec_() != QDialog.Accepted:
            sys.exit(0)
        self.username = login_window.result
    ...
    def excepthook(self, exc_type, exc_value, exc_tb):
        ...
        try:
            ...
            print("Exception during UI initialization:", exc_value)
