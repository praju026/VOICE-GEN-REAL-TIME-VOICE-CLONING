...
class UI(QDialog):
    ...
    def __init__(self, username=None):
        ...
        self.setWindowIcon(QIcon("icon.png"))  # Optional: set your icon file here
        ...
        self.setStyleSheet("""
            ...
            QComboBox, QLineEdit, QPlainTextEdit, QLabel, QProgressBar {
...
# User Info Panel
        user_info = QLabel(f"<b>Logged in as:</b> {self.username}")
        browser_layout.addWidget(user_info, 0, 0, 1, 4)
        ...
        max_size = QDesktopWidget().availableGeometry(self).size() * 0.9
